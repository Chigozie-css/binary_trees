 ...
 *
 * Description: This function balances an AVL tree by performing rotations
 * as necessary. It is called recursively on each subtree.
 */
void bal(avl_t **tree)
{
	int bval;
...
/**
 * successor - Finds the next successor, i.e., the min node in the right subtree.
 ...
 * Return: 0 if it has no children, or the value if it has.
 */
